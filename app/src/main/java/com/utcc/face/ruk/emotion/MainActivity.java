package com.utcc.face.ruk.emotion;
...
import com.utcc.face.ruk.emotion.helper.ImageHelper;
    ...
    private class doRequest extends AsyncTask<String, String, List<RecognizeResult>> {
        ...
        protected void onPostExecute(List<RecognizeResult> result) {
            ...
            if (e != null) {
                ...
                mTextView.setText("เกิดข้อผิดพลาด: กรุณาตรวจสอบการเชื่อมต่อ Internet ");
                this.e = null;
            } else {
                if (result.size() == 0) {
